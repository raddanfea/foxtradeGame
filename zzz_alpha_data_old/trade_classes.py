...
class inventoryBox:
    def __init__(self, screen, player, width):
        ...
        self.bg = pygame.image.load('../assets/gui/generic_frame.png').convert()
    ...
    def drawBox(self):
        ...
        self.screen.braw_bg(self.bg, bg_pos)
        ...
        for x, each in enumerate(has_items):
            ...
            self.screen.braw_bg(self.itembg, box_pos)
            ...
            self.screen.braw_bg(each[1].item_icon, icon_pos)
