...
def draw_menu_ui(game: GameObject):
    draw_text(
        ...
        color=(0, 0, 0), surface=game.screen.screen, x=game.screen.screen.get_width() * 0.5, y=game.screen.screen.get_height() * 0.4,
...
def draw_menu_buttons(game: GameObject):
    ...
    button1 = TextButton(
        ...
        color=(0, 0, 0), surface=game.screen.screen, x=game.screen.screen.get_width() * 0.3, y=game.screen.screen.get_height() * 0.6,
    ...
    button2 = TextButton(
        ...
        color=(0, 0, 0), surface=game.screen.screen, x=game.screen.screen.get_width() * 0.5, y=game.screen.screen.get_height() * 0.6,
        w=0, h=0, center=True, font=game.fonts.button)
    ...
    button3 = TextButton(
        ...
        color=(0, 0, 0), surface=game.screen.screen, x=game.screen.screen.get_width() * 0.7, y=game.screen.screen.get_height() * 0.6,
        w=0, h=0, center=True, font=game.fonts.button)
